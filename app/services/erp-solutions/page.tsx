...
const data: ServicePageData = {
  ...
  overview:
    'At Tronexa, we go beyond software — we provide ERP as a fully managed service, handling implementation, configuration, integration, and ongoing support so your team can stay focused on what they do best: delivering exceptional technology solutions. We centralize finance, inventory, procurement, CRM, supply chain, and reporting into a single source of truth — automating workflows, configuring real-time executive dashboards, migrating legacy data securely, and customizing modules to fit exactly how your business operates.',
  deliverablesLabel: 'ERP Platforms We Manage',
  deliverablesHeading: '10 leading ERP systems,\nfully managed by Tronexa',
  deliverables: [
    ...
    { num: '02', title: 'Oracle NetSuite', desc: 'Oracle NetSuite is the cloud ERP of choice for companies that need to unify financials, inventory, procurement, order management, CRM, and projects in one place. Tronexa delivers complete NetSuite implementation and management — SuiteScript 2.0 customization, SuiteCommerce front-end work, SuiteTalk and REST/SOAP integrations, multi-entity and revenue-recognition configuration, secure data migration, and SuiteAnalytics dashboards — hosted on Oracle Cloud Infrastructure with high availability and automatic backups.' },
    { num: '03', title: 'Microsoft Dynamics 365', desc: 'Built for organizations running on the Microsoft stack, Dynamics 365 connects ERP and CRM into a single, intelligent platform spanning Finance, Supply Chain, Sales, Customer Service, and Field Service. Tronexa handles the entire lifecycle on Microsoft Azure — Dataverse and SQL Server data, Power BI dashboards, Power Automate workflows, Power Apps extensions, SharePoint document management, AI-powered insights, and Azure AD security — so adoption is smooth, governance is enterprise-grade, and ROI is fast.' },
    ...
    { num: '06', title: 'Epicor ERP (Kinetic)', desc: 'For manufacturing, distribution, and technology operations, Epicor Kinetic delivers precise control over production planning, shop-floor scheduling, MRP, inventory, quality, and multi-site management. Tronexa manages your Epicor environment fully — C#/.NET and Epicor Application Studio customization, Epicor BPM workflows, Service Connect and REST/SOAP integrations, Epicor Data Analytics and Power BI reporting, and ECM document management on Epicor Cloud or Azure — so your operations run without interruption.' },
