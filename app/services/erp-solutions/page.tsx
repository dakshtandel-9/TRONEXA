...
const data: ServicePageData = {
  ...
  heroDesc:
    'In today\'s fast-moving IT landscape, disconnected systems and manual processes are the biggest barriers to growth. An ERP platform brings every critical function — from project management and resource planning to finance, procurement, and client delivery — into one intelligent, unified system.',
  overview:
    'An ERP (Enterprise Resource Planning) platform gives IT companies real-time visibility across operations, eliminates inefficiencies, and enables data-driven decision-making at every level. At Tronexa, we go beyond software — we provide ERP as a fully managed service, handling implementation, configuration, integration, and ongoing support so your team can stay focused on what they do best: delivering exceptional technology solutions.',
  deliverables: [
